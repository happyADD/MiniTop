...
void Can1ChassisMotorFilterConfig()
{
	...
	CAN1_Filter.FilterIdHigh         = 0x4020;  //0x201
	CAN1_Filter.FilterIdLow          = 0x4040;  //0x202
	CAN1_Filter.FilterMaskIdHigh     = 0x4060;  //0x203
	CAN1_Filter.FilterMaskIdLow      = 0x4080;  //0x204
